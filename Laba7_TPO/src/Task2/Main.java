...
public class Main {
    ...
    public static void main(String[] args) {    //багато-до-багатьох
        {
            MPI.Init(args);
            ...
            MPI.COMM_WORLD.Allgather(Array.convert2DTo1D(resultMatrix), 0, rowsPerProcess * SIZE, MPI.DOUBLE,
                    matrixC1D, 0, rowsPerProcess * SIZE, MPI.DOUBLE);
            if(currentProcess == MASTER) {
